  ...
  return (
    <Layout>
      <PageHero
        ...
        subtitle="Black Chana, White Chana, Masoor Dal, Turmeric and Moringa Powder — grown and prepared close to the source."
      />
        ...
        <Reveal>
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-[16px] leading-relaxed text-forest-900/70">
              Beyond fresh vegetables and fruits, our farm also grows pulses and select
              produce such as turmeric and moringa. These are grown, harvested and prepared
              with the same farm-first approach as everything else we offer.
            </p>
            <a
